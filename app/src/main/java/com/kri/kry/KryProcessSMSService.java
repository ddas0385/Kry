 ...
 * helper methods.
 */
public class KryProcessSMSService extends IntentService {
    ...
    public static final String ACTION_PROCESS_SMS = "com.kri.kry.intent.action.PROCESS_SMS";
    ...
    public KryProcessSMSService() {
        super("KryProcessSMSService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            if (ACTION_FOO.equals(action)) {
                ...
                SMSInbox objSMSInbox = intent.getParcelableExtra("SMSInbox");

                new ProcessSMS().ProcessSMSInbox(getApplicationContext(), objSMSInbox);

                Intent broadcastIntent = new Intent();
                broadcastIntent.setAction(this.ACTION_PROCESS_SMS);
